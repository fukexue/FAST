...
class CervicalCaner_16(torch.utils.data.Dataset):
    # @profile
    def __init__(self, root_dir="/media/xiaoyuan/One Touch/QLH_Data/MIL_scale3_datasets",
...
class CervicalCaner_16_feat(torch.utils.data.Dataset):
    def __init__(self, root_dir="/media/xiaoyuan/One Touch/QLH_Data/MIL_scale3_datasets",
                 train=True, return_bag=True, feat="SimCLR"):
        self.root_dir = root_dir
        self.train = train
        self.return_bag = return_bag
        ...
        if feat == 'SimCLR':
            save_path = "/home/xiaoyuan/CPC_SSL/dsmil-wsi/simclr/runs_forCervicalCancer/20220210_173056_MIL_SimCLR_CervicalCancer/"
        elif feat == 'NIGD':
            save_path = "/home/xiaoyuan/CPC_SSL/MIL_sela/results_CervicalCancer/"
        elif feat == 'CLIP':
            save_path = "/home/xiaoyuan/VL/CLIP_Pathology/output_CervicalCancer_feat_224x224_5x_CLIP(RN50)"
        else:
...
if __name__ == '__main__':
    ...
    val_ds_return_instance = CervicalCaner_16_feat(train=False, return_bag=False)

    # root_dir = "/media/xiaoyuan/One Touch/QLH_Data/MIL_scale2_datasets"
    root_dir = "/media/xiaoyuan/One Touch/QLH_Data/MIL_scale3_datasets"
