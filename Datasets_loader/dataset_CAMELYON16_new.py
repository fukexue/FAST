...
class CAMELYON_16_5x_feat(torch.utils.data.Dataset):
    # @profile
    def __init__(self, root_dir='/home/science/code/fast code dataset/Project_FAST/CODE/MIL_CLIP_Adapter/output_CAMELYON_feat_224x224_5x',
        ...
        if (feat == 'CLIP') or (feat == 'CLIP_RN50') or (feat == 'RN50'):
            save_path = "/home/science/code/fast code dataset/Project_FAST/CODE/MIL_CLIP_Adapter/output_CAMELYON_feat_224x224_5x_CLIP(RN50)"
        elif feat == 'CLIP_ViTB32':
            save_path = "/home/xiaoyuan/CPC_SSL/MIL_CLIP_New/output_CAMELYON_feat_224x224_5x"
        else:
