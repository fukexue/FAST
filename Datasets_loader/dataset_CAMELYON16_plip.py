...
class CAMELYON_16_5x(torch.utils.data.Dataset):
    # @profile
    def __init__(self, root_dir='/home/science/Downloads/nips2024data/d69acdab5e934806b3af57120b593535/patches_byDSMIL_224x224_5x',
...
class CAMELYON_16_5x_feat(torch.utils.data.Dataset):
    # @profile
    def __init__(self, root_dir='/home/science/code/python3/plip/output_CAMELYON_feat_224x224_5x_PLIP', split='train', return_bag=False):
        self.root_dir = root_dir
        self.split = split
        self.return_bag = return_bag
...
def camelyon16_dataloader(only_return_valloader=False, batch_size=8):
    if only_return_valloader:
        val_ds = CAMELYON_16_5x(train=False, downsample=1.0, return_bag=False)
        ...
        train_ds = CAMELYON_16_5x(train=True, transform=transform_data, downsample=1.0, return_bag=False)
        val_ds = CAMELYON_16_5x(train=False, downsample=1.0, return_bag=False)
...
if __name__ == '__main__':
    ...
    train_ds = CAMELYON_16_5x(train=True, transform=transform_data, downsample=0.01, return_bag=False)
    val_ds = CAMELYON_16_5x(train=False, transform=transform_data, downsample=0.01, return_bag=False)
