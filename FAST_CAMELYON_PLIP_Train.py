...
from Datasets_loader.dataset_CAMELYON16_plip import CAMELYON_16_5x_feat
...
def load_clip_to_cpu(backbone_name="RN50", plip_model=None):
...
if __name__ == '__main__':
    ...
    # Setup loaders
    train_ds_return_bag = CAMELYON_16_5x_feat(split='train', return_bag=True)
    ...
    val_ds_return_bag = CAMELYON_16_5x_feat(split='test', return_bag=True)
    ...
    clip_model = load_clip_to_cpu(backbone_name='RN50', plip_model=plip_model.model).cuda()
